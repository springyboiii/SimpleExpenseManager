...
public abstract class ExpenseManager implements Serializable {
     ...
     */
    public void addAccount(String accountNo, String bankName, String accountHolderName, double initialBalance,DBHandler dbHandler) {
        Account account = new Account(accountNo, bankName, accountHolderName, initialBalance);
        accountsHolder.addAccount(account);
        dbHandler= dbHandler;
        dbHandler.addNewAccount(accountNo, bankName, accountHolderName, initialBalance);
    }
